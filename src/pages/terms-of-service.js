...
const data = [
  ...
  <br />,
  <H31Text3>
    Welcome to the Central Florida Musicians&apos; Association (CFMA) Website.
  ...
  <H31Text3>
    By using and/or visiting this Website (the CFMA Website,” or “Website”), you
    signify your agreement to (1) these terms and conditions (the “Terms of
    Service”), (2) CFMA’s Privacy Policy, incorporated here by reference, and
    (3) CFMA’s Community Guidelines, also incorporated here by reference. If you
    do not agree to any of these terms, the Privacy Policy, or Community
    Guidelines, you are not authorized to use the CFMA Website.
    <br />
    <br />
    ...
    version. CFMA may, in its sole discretion, modify these Terms of Service at
    ...
    <br />
    <br />
    Through our sites, CFMA provides users with access to a rich array of
    ...
    <br />
    <br />
    CFMA hereby grants you permission to access and use the Website as set forth
    ...
    <H31ListNumbered1>
      ...
      <H31Item1>
        ...
        written authorization of CFMA. You agree not to transmit or otherwise
      ...
      <H31Item1>
        ...
        Website in a manner that sends more request messages to the CFMA servers
        ...
        the foregoing, CFMA grants the operators of public search engines
        ...
        archives of such materials. CFMA reserves the right to revoke these
      ...
      <H31Item1>
        ...
        ethnically, or otherwise objectionable, as solely determined by CFMA.
      </H31Item1>
      <H31Item1>
        CFMA reserves the right to change or discontinue any aspect of the
        Website at any time, for any reason, and without notice to you.
      </H31Item1>
      <H31Item1>
        CFMA reserves the right to suspend or terminate a user’s access to the
        Website, without prior notice and at CFMA’s sole discretion.
      </H31Item1>
      <H31Item1>
    ...
    C. CFMA Registered User Accounts
    <br />
    <br />
    ...
    <H31ListNumbered1>
      <H31Item1>
        ...
        username/password assigned to you. You must notify CFMA immediately of
        any breach of security or unauthorized use of your account. You may
        never use another’s account without permission.
      </H31Item1>
      <H31Item1>
        As a Registered User you may submit comments on various CFMA blogs or
        other material (collectively, “User Content”) to the Website. CFMA
        ...
        notice. CFMA also reserves the right to suspend or terminate a
        Registered User’s access for posting User Content.
      </H31Item1>
      <H31Item1>
        ...
        and permissions to use and authorize CFMA to use, all patent, trademark,
      ...
      <H31Item1>
        ...
        by submitting User Content to CFMA, you hereby grant CFMA a worldwide,
        ...
        connection with the activities and operations of CFMA, its affiliated
        entities and successors. You also hereby grant each user of the CFMA
        ...
        that CFMA may retain, reproduce, distribute and otherwise use for any
      ...
      <H31Item1>
        CFMA does not endorse, authorize or ratify any User Content, or any
        opinion, recommendation, or advice expressed therein, and CFMA expressly
        disclaims all liability in connection with User Content. CFMA does not
        permit copyright infringing activities and infringement of intellectual
        property rights on its Website, and CFMA reserves the right, but does
        not assume the obligation, to remove any content from the Website if
    ...
    conditions apply specifically to your use of content on the CFMA Website.
    <br />
    <br />
    <H31ListNumbered1>
      <H31Item1>
        ...
        CFMA Content”) is owned by or licensed by CFMA. Similarly, the
        trademarks, service marks and logos contained on the Website are owned
        or licensed by CFMA (CFMA Marks”). Except as otherwise provided in these
        Terms of Service, the CFMA Content and the CFMA Marks may not be
        ...
        whatsoever without the prior written consent of CFMA. CFMA reserves all
        rights not expressly granted in and to the CFMA Content and the CFMA
        Marks.
      </H31Item1>
      <H31Item1>
      ...
      <H31Item1>
        You understand that when using the CFMA Website, you will be exposed to
        CFMA Content, User Content, and other third-party content from a variety
        of sources, and that CFMA makes no warranty about the accuracy,
        usefulness, safety, or intellectual property rights of or relating to
        such CFMA Content, User Content, or other third-party content. You
        ...
        or remedies you have or may have against CFMA with respect thereto.
      </H31Item1>
      <H31Item1>
        The Website may contain links to third party websites that are not owned
        or controlled by CFMA. CFMA has no control over, and assumes no
    ...
    <br />
    <br />
    If you are a copyright owner or an agent thereof and believe that any CFMA
    ...
    providing CFMA’s Copyright Agent with the following information in writing
    ...
    <H31ListBullet1>
      ...
      <H31Item1>
        ...
        permit CFMA to locate the material;
      </H31Item1>
      <H31Item1>
      ...
      <H31Item1>
        ...
        behalf of the owner. CFMA’s designated Copyright Agent to receive
    ...
    support, or other communications with CFMA.
    <br />
    <br />
    F. Warranty Disclaimer
    <br />
    <br />
    THIS WEBSITE IS PROVIDED TO YOU “AS IS.” YOU AGREE THAT YOUR USE OF THE CFMA
    WEBSITE SHALL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW,
    CFMA, AS WELL AS ITS OFFICERS, DIRECTORS, EMPLOYEES, AND AGENTS
    (COLLECTIVELY, THE CFMA PARTIES”), DISCLAIM ALL WARRANTIES, EXPRESS OR
    IMPLIED, IN CONNECTION WITH THE WEBSITE AND YOUR USE THEREOF. THE CFMA
    ...
    CFMA PARTIES GUARANTEE THAT THE WEBSITE WILL BE ERROR FREE, OR CONTINUOUSLY
    AVAILABLE, OR THAT THE WEBSITE WILL BE FREE OF VIRUSES OR OTHER HARMFUL
    COMPONENTS. THE CFMA PARTIES DO NOT WARRANT, GUARANTEE, OR ASSUME
    RESPONSIBILITY FOR ANY PRODUCT OR SERVICE PROVIDED, ADVERTISED OR OFFERED BY
    A THIRD PARTY THROUGH THE CFMA WEBSITE OR ANY HYPERLINKED WEBSITE OR
    ...
    <br />
    <br />
    IN NO EVENT SHALL THE CFMA PARTIES BE LIABLE TO YOU OR ANYONE ELSE FOR ANY
    ...
    VIA THE CFMA WEBSITE, WHETHER BASED ON WARRANTY, CONTRACT, TORT, OR ANY
    OTHER LEGAL THEORY, AND WHETHER OR NOT CFMA IS ADVISED OF THE POSSIBILITY OF
    SUCH DAMAGES. YOU SPECIFICALLY ACKNOWLEDGE THAT THE CFMA PARTIES SHALL NOT
    BE LIABLE FOR USER CONTENT OR THE DEFAMATORY, OFFENSIVE, OR ILLEGAL CONDUCT
    OF ANY THIRD PARTY AND THAT THE RISK OF HARM OR DAMAGE FROM THE FOREGOING
    RESTS ENTIRELY WITH YOU. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON
    IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. TO THE
    EXTENT THESE LAWS APPLY TO YOU, SOME OF THE PROVISIONS SET FORTH IN THIS
    AGREEMENT MAY NOT APPLY. YOU AGREE TO INDEMNIFY AND HOLD HARMLESS THE CFMA
    PARTIES AGAINST ANY AND ALL CLAIMS, OF WHATEVER NATURE, THAT ARISE OUT OF
    YOUR USE OF AND ACCESS TO THE CFMA WEBSITE OR YOUR VIOLATION OF ANY OF THESE
    TERMS OF SERVICE. THIS INDEMNIFICATION OBLIGATION WILL SURVIVE THESE TERMS
    OF SERVICE AND YOUR USE OF THE CFMA WEBSITE.
    <br />
    <br />
    ...
    that you are over the age of 13, as the CFMA Website is not intended for
    children under 13.
    <br />
    <br />
    I. Miscellaneous
    ...
    claim or dispute between you and CFMA that arises in whole or in part from
    the CFMA Website shall be decided exclusively by a court of competent
    jurisdiction located in Washington, D.C. These Terms of Service, together
    with the Privacy Policy and any other legal notices published by CFMA on the
    Website, shall constitute the entire agreement between you and CFMA
    concerning the CFMA Website and supersedes prior agreements, if any, between
    you and CFMA relating to any matter dealt with in the Terms of Service. If
    ...
    or any other term, and CFMA’s failure to assert any right or provision under
    ...
    CFMA without restriction. This Agreement and the rights and obligations
    ...
    <br />
    <br />
    You and CFMA agree that any cause of action arising out of or related to the
    CFMA Website must commence within one (1) year after the cause of action
